...
if ($_SESSION["userType"]=="admin") {
    ...
    $success_msg = "";
    $sql_Appint = "SELECT booking_id,user_name as client_name,first_name,last_name ,date,time,status from appointment 
    INNER JOIN user on client_id=user_id 
    INNER JOIN user_details on lawyer_id=user_fk_id ";
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?php echo $fatchAp['first_name']." ".$fatchAp['last_name']; ?></td>
                                        <td><?php echo $fatchAp['client_name']; ?></td>
                                        ...
                                        echo '</td>'; ?>
                                        <td>
                                            <a class="btn btn-danger" href="deleteappoint.php?app_id=<?php echo $fatchAp['booking_id'];?>" >
