...
if ($_SESSION["userType"]=="lawyer") {
    ...
    $sql_Appint = "SELECT booking_id,user_name,date,time,status from appointment
        INNER JOIN user on client_id=user_id where lawyer_id=$lawyer_id And status = 'pending' ";
    ...
    <div class="content container">
        <div class="row">
            <div class="col-sm-4 col-3">
                <h4 class="page-title"> New Appointments</h4>
            </div>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="app_id" value="<?php echo $fatchAp['booking_id'];?>">
                                        </td>
                                        <td class="text-right">
                                            <button type="submit" name="submit" class="btn btn-info" ><i class="fa fa-trash-o m-r-5"></i>Submit</button>
                                        </td>
                                        </form>
                                    </tr>
                                <?php }
